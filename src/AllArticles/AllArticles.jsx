...
export default function AllArticles() {
  ...
  // جلب نص البحث المصدر من الـ Parent عبر useOutletContext
  ...
  // حالة الصفحة الحالية وعدد العناصر بالصفحة
  ...
  // إرجاع الترقيم للصفحة الأولى عند تغير الكلمة المبحوث عنها
  useEffect(() => {
    setCurrentPage(1);
  }, [searchQuery]);
            ...
            >
              <div className="p-6 md:p-8 flex-1 flex flex-col justify-between space-y-6">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <div className="flex items-center gap-2 text-xs font-bold text-[#FF6000] group-hover:text-white transition-colors group/btn">
