...
export default function NaturalLandscapes() {
  ...
  if (loading) {
    return (
      <div
        ...
        dir="rtl"
      >
        جاري تحميل مقالات المناظر الطبيعية...
      </div>
    );
  }

  // تصفية البيانات حسب قسم المناظر الطبيعية
  const filteredProducts = products.filter(
    (post) => post.category === "مناظر طبيعية",
  );
    ...
    <div dir="rtl" className="w-full pt-4 space-y-8 font-sans">
      ...
      <div className="flex justify-between items-center border-b border-neutral-800/80 pb-4">
        ...
        <div className="text-sm font-semibold text-neutral-300">
          ...
          مقالات في <strong className="text-[#FF6000]">مناظر طبيعية</strong>
        </div>
